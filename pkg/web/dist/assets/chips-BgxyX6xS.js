import{F as b,H as P,I as A,M as u,O as p,P as x,R as w,_ as f,at as y,ct as D,d as j,g as k,h as g,v as l,x as $}from"./vue.runtime.esm-bundler-DjU52oeN.js";import{t as S}from"./style-wGJAwGpx.js";import{i as z,n as V}from"./baseicon-DpsUgPrD.js";import{n as F}from"./toast-DEjaZJUs.js";var L=`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,T=S.extend({name:"chip",style:L,classes:{root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"}}),E={name:"BaseChip",extends:V,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:T,provide:function(){return{$pcChip:this,$parentInstance:this}}},B={name:"Chip",extends:E,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return z({removable:this.removable})}},components:{TimesCircleIcon:F}},R=["aria-label","data-p"],N=["src"];function M(n,e,i,t,r,o){return r.visible?(u(),l("div",p({key:0,class:n.cx("root"),"aria-label":n.label},n.ptmi("root"),{"data-p":o.dataP}),[b(n.$slots,"default",{},function(){return[n.image?(u(),l("img",p({key:0,src:n.image},n.ptm("image"),{class:n.cx("image")}),null,16,N)):n.$slots.icon?(u(),k(w(n.$slots.icon),p({key:1,class:n.cx("icon")},n.ptm("icon")),null,16,["class"])):n.icon?(u(),l("span",p({key:2,class:[n.cx("icon"),n.icon]},n.ptm("icon")),null,16)):f("",!0),n.label!==null?(u(),l("div",p({key:3,class:n.cx("label")},n.ptm("label")),D(n.label),17)):f("",!0)]}),n.removable?b(n.$slots,"removeicon",{key:0,removeCallback:o.close,keydownCallback:o.onKeydown},function(){return[(u(),k(w(n.removeIcon?"span":"TimesCircleIcon"),p({class:[n.cx("removeIcon"),n.removeIcon],onClick:o.close,onKeydown:o.onKeydown},n.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):f("",!0)],16,R)):f("",!0)}B.render=M;var W=`
    .p-inputchips {
        display: inline-flex;
    }
