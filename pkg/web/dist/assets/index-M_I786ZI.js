import{a as A}from"./index-vgqNqeEN.js";import{s as S,f as P}from"./index-DQA6y92b.js";import{B as V,o as u,c as l,y,x as p,s as w,z as k,d as f,t as x,v as D,a as b,F as j,g as $,h as z,p as F,n as g}from"./index-DfZ6JomF.js";var L=`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,H={root:function(e){var i=e.instance,t=e.props;return["p-inputchips p-component p-inputwrapper",{"p-disabled":t.disabled,"p-invalid":t.invalid,"p-focus":i.focused,"p-inputwrapper-filled":t.modelValue&&t.modelValue.length||i.inputValue&&i.inputValue.length,"p-inputwrapper-focus":i.focused}]},input:function(e){var i=e.props,t=e.instance;return["p-inputchips-input",{"p-variant-filled":i.variant?i.variant==="filled":t.$primevue.config.inputStyle==="filled"||t.$primevue.config.inputVariant==="filled"}]},chipItem:function(e){var i=e.state,t=e.index;return["p-inputchips-chip-item",{"p-focus":i.focusedIndex===t}]},pcChip:"p-inputchips-chip",chipIcon:"p-inputchips-chip-icon",inputItem:"p-inputchips-input-item"},q=V.extend({name:"inputchips",style:U,classes:H}),G={name:"BaseInputChips",extends:S,props:{modelValue:{type:Array,default:null},max:{type:Number,default:null},separator:{type:[String,Object],default:null},addOnBlur:{type:Boolean,default:null},allowDuplicate:{type:Boolean,default:!0},placeholder:{type:String,default:null},variant:{type:String,default:null},invalid:{type:Boolean,default:!1},disabled:{type:Boolean,default:!1},inputId:{type:String,default:null},inputClass:{type:[String,Object],default:null},inputStyle:{type:Object,default:null},inputProps:{type:null,default:null},removeTokenIcon:{type:String,default:void 0},chipIcon:{type:String,default:void 0},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:q,provide:function(){return{$pcInputChips:this,$parentInstance:this}}};function m(n){return Y(n)||X(n)||Q(n)||J()}function J(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
