...
func NewDB(path string) (*DB, error) {
	...
	// Initialize schema
	// Initialize extended schema for multi-user, audit, etc.	if err := db.initExtendedSchema(); err != nil {		return nil, fmt.Errorf("failed to initialize extended schema: %w", err)	}
