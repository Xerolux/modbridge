...
func (m *Metrics) GetPrometheusMetrics() string {
	...
	// System-wide metrics
	output.WriteString("# HELP modbridge_total_requests Total number of requests\n")
	output.WriteString("# TYPE modbridge_total_requests counter\n")
	output.WriteString(fmt.Sprintf("modbridge_total_requests %d\n\n", stats.TotalRequests))

	output.WriteString("# HELP modbridge_total_errors Total number of errors\n")
	output.WriteString("# TYPE modbridge_total_errors counter\n")
	output.WriteString(fmt.Sprintf("modbridge_total_errors %d\n\n", stats.TotalErrors))

	output.WriteString("# HELP modbridge_total_connections Total number of connections\n")
	output.WriteString("# TYPE modbridge_total_connections counter\n")
	output.WriteString(fmt.Sprintf("modbridge_total_connections %d\n\n", stats.TotalConnections))

	output.WriteString("# HELP modbridge_uptime_seconds Uptime in seconds\n")
