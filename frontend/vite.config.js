    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          if (id.includes('primevue/inputtext') || id.includes('primevue/inputnumber') || id.includes('primevue/checkbox') || id.includes('primevue/select') || id.includes('primevue/inputtags') || id.includes('primevue/password') || id.includes('primevue/toggleswitch') || id.includes('primevue/selectbutton')) return 'vendor-ui-form';
