...
const de = {
  ...
  control: {
    ...
    form: {
      ...
      calibrateHint: 'Tastet Abstand, Verbindungen und Antwortzeit am echten Gerät ab. Nur Lesezugriffe, und der Proxy nimmt währenddessen keine Clients an.',
...
const en = {
  ...
  control: {
    ...
    form: {
      ...
      calibrateHint: 'Probes spacing, connections and response time on the real device. Reads only, and the proxy accepts no clients while it runs.',
