  ...
  control: {
    ...
    profiles: {
      ...
      classes: {
        ...
        singleSessionSlow: 'Eine Sitzung, träge Steuerung: 100 ms Abstand, 10 s Lese-Timeout, Cache (5 s) mit Hintergrund-Poller — der Client wartet nicht mehr auf das Gerät',
  ...
  control: {
    ...
    profiles: {
      ...
      classes: {
        ...
        singleSessionSlow: 'One session on a slow controller: 100 ms spacing, 10 s read timeout, 5 s cache with a background poller — the client stops waiting for the device',
