...
const de = {
  ...
  control: {
    ...
    form: {
      ...
      calibrateHint: 'Tastet Abstand, Verbindungen und Antwortzeit am echten Gerät ab. Nur Lesezugriffe. Der Proxy nimmt währenddessen keine Clients an — in dieser Zeit wird nichts abgefragt oder geregelt. Dauer maximal 90 Sekunden.',
...
const en = {
  ...
  control: {
    ...
    form: {
      ...
      calibrateHint: 'Probes spacing, connections and response time on the real device. Reads only. The proxy accepts no clients while it runs — nothing is polled or controlled during that time. At most 90 seconds.',
